    ...
    <div class="login-container">
      ...
      <div class="login-content">
        ...
        <div id="auditor-login" class="login-form" style="display: none;">
          ...
          <div class="form-group">
            <label>Password</label>
            <input type="password" id="auditor-password" placeholder="Enter auditor password" />
          </div>
...
# ⚠️ SECURITY-CRITICAL: Secret Management
# MANDATORY HUMAN REVIEW REQUIRED before merge
# Changes to authentication secret handling must be reviewed by security team

import os

# Agent Ecosystem Defense: Signed communication between agents
AGENT_SIG_SECRET = os.getenv("AGENT_SIG_SECRET")
if not AGENT_SIG_SECRET:
    raise ValueError(
        "AGENT_SIG_SECRET environment variable must be set. "
...
MCP_SIG_SECRET = os.getenv("MCP_SIG_SECRET")
if not MCP_SIG_SECRET:
    raise ValueError(
        "MCP_SIG_SECRET environment variable must be set. "
        "See .env.example for configuration instructions."
    )
