...
Walkthrough script for the Blue Team Enterprise Copilot.
...
Usage:
  ...
  (Run the FastAPI app separately with: uvicorn blue_team_ai.interfaces.api:app --reload --port 8000)
...
def start_uvicorn(app_module: str = "blue_team_ai.interfaces.api:app", port: int = 8000):
...
def main():
    parser = argparse.ArgumentParser(description="Demo runner for Blue Team Enterprise Copilot (safe).")
